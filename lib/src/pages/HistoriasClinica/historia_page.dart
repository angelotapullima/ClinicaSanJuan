...
import 'package:clinica_app/src/pages/HistoriasClinica/formulario_historia_page.dart';
      ...
      appBar: AppBar(
        title: Row(
          children: [
            ...
            Text(
              "Historia clínica",
              style: TextStyle(fontSize: responsive.ip(3.5), color: Colors.white, fontWeight: FontWeight.w700),
            ),
          ],
        ),
        elevation: 0,
            ...
            child: ListView.builder(
                ...
                itemBuilder: (_, index) {
                  if (index == pacientes.length) {
                    return SizedBox(height: responsive.hp(5));
                  }
                  return InkWell(
                    onTap: () {
                      Navigator.push(
